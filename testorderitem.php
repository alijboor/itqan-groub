...
$res_orderdet=mysqli_query($conn, "SELECT ordersdet.detid, ordersdet.quantity, items.itemstring,items.barcode, ordersdet.status, items.itemtype,items.itemparent,items.itemid ,items.prop1 ,items.prop2, ordersdet.theorderid FROM ordersdet INNER JOIN items ON ordersdet.theitemid=items.itemid ORDER BY items.itemid;");
